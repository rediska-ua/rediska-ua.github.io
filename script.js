...
fetch('https://my-json-server.typicode.com/rediska-ua/websiteShop/products', {method: 'POST'})
  .then((response) => {
...
const getData = async () => {
  ...
  let responseStatus = fetch('https://my-json-server.typicode.com/rediska-ua/websiteShop/products')
      .then((response) => {
        return response.json();
      })
      
      
  await responseStatus.then((data) => {
        arrayProducts = data;
      });
...
button.addEventListener('click', () => {toChangeLocation()});*/
